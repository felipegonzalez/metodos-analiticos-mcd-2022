...
más flexibles que conmunmente utilizamos (pandas y dplyr), ver por ejemplo [aquí](https://h2oai.github.io/db-benchmark/), o utilizar bases de datos tradicionales,
...
sc <- spark_connect(master = "spark://127.0.0.1:7077",
                    spark_home = "/home/rstudio/spark/spark-3.0.2-bin-hadoop3.2")
sc$conf
```
